            ...
            .then((getMeal) => {
                ...
                fetch(`https://www.themealdb.com/api/json/v1/1/lookup.php?i=${generateRandomRecipe.idMeal}`)
                    ...
                    .then((getRandomRecipe) => {
                        ...
                        let altText = randomRecipe.strMeal;
                        if (randomRecipe.strCategory) altText += ` (${randomRecipe.strCategory})`;
                        if (randomRecipe.strArea) altText += `, ${randomRecipe.strArea}`;
                        mealImage.alt = altText;
